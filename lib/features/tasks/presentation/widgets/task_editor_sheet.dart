    ...
    builder: (sheetContext) {
      return GestureDetector(
        ...
        child: const ColoredBox(
          ...
          child: _TaskEditorSheetScaffold(),
        ),
      );
    },
  );
...
class _TaskEditorSheetScaffold extends StatelessWidget {
  const _TaskEditorSheetScaffold();
    ...
    return GestureDetector(
      ...
      child: DraggableScrollableSheet(
        ...
        builder: (_, controller) {
          return _TaskEditorSheetBody(controller: controller);
        },
      ),
    );
  }
...
class _TaskEditorSheetBody extends ConsumerWidget {
  const _TaskEditorSheetBody({required this.controller});
                  ...
                  Expanded(
                    child: CupertinoButton(
                      ...
                      onPressed: () async {
                        ...
                        final attachedLink = taskLinkController.text.trim();
